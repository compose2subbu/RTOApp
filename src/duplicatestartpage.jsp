...
<title>Duplicate license application</title>
...
<s:form action="dupstart" method="POST">
<s:textfield label="Username" name="username" readonly="true" value="<%=sess %>"></s:textfield><br>
<s:property value="equality"/><br>
<s:textfield label="License number" name="licensenumber"></s:textfield><br>
