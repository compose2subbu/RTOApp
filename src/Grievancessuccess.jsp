...
The Entered Details
<br>
<s:label label="Please Note Your Grievance Id"/>
<br>
<br>
<s:label name="user_name " label="Name"/><br>
<s:label name="grievances_id " label="Grievance Id"/><br>
<s:label name="service_type " label="Service Type"/><br>
<s:label name="sub_service_type" label="Sub Service Type"/>
</center>
</body>
</html>
