...
<h2 align="center">ALTERATION FORM</h2>
<s:form name="admin_alter_update"  id="admin_alter_update" action="admin_alter_update">
<pre>
...
ALTERATION MADE      :<s:property value="alter"/><br>
</pre>
