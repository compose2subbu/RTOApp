...
<center>
<h1><b>Enter You Registration Number To View The F.C Status</b></h1>
<br>
<br>

<s:form action="reg_status">
 
<s:textfield name="number" label="Registration Number ">
</s:textfield>
<s:property value="equality"/>
<s:submit value="Click To See Status">
</s:submit>
</s:form>
